...
class MyDiagram extends PureComponent<MyDiagramProps> {
    ...
    public createDiagram(diagramId: string): Diagram {
        ...
        myDiagram.nodeTemplate = $(
            ...
            'Auto',
            {
                selectionChanged: (node: any) => this.props.onNodeSelection(node.key as string, node.isSelected)
            },
    ...
    public onTextEdited(e: go.DiagramEvent) {
        const tb = e.subject;
        if (tb === null) {
            return;
        }
